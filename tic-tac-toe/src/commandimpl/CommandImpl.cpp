...
CommandFactory::CommandFactory(TttContext &gc) : 
                m_commandMap(), m_tttContext(gc)
{
...
{
  return shared_ptr<CommandImpl>(new QuitCommand(m_tttContext));
}
...
shared_ptr<CommandImpl> CommandFactory::makeStartGameCommand(
                                           const string &param)
{
  return shared_ptr<CommandImpl>(new StartGameCommand(m_tttContext));
}
...
shared_ptr<CommandImpl> CommandFactory::makePrintStatsCommand(
                                           const string &param)
{
  return shared_ptr<CommandImpl>(new PrintStatsCommand(m_tttContext));
}
 ...
 */
CommandImpl::CommandImpl(TttContext &tttContext):m_tttContext(tttContext)
{
}
 ...
 */
QuitCommand::QuitCommand(TttContext &tttContext)
    :CommandImpl(tttContext)
{
}
...
RegisterPlayerCommand::RegisterPlayerCommand(TttContext &tttContext)
    :CommandImpl(tttContext)
{
}
...
bool RegisterPlayerCommand::execute()
{
  ...
  return m_tttContext.registerPlayer();
}
...
StartGameCommand::StartGameCommand(TttContext &tttContext)
    :CommandImpl(tttContext)
{
}
 ...
 * @param tttContext Empty game context object.
 */
PrintStatsCommand::PrintStatsCommand(TttContext &tttContext)
    :CommandImpl(tttContext)
{
}
...
{
  //call handleRegister Player on the gamecontext
  return m_tttContext.printStats();
}
